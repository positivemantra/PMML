...
const translations = {
  en: {
    ...
    allRightsReserved: "2026 Prime Ministers Museum & Library. All Rights Reserved.",
  ...
  hi: {
    ...
    allRightsReserved: "2026 प्रधान मंत्री संग्रहालय और पुस्तकालय। सर्वाधिकार सुरक्षित।",
