...
const MILESTONES = [
  {
    ...
    image: '/Timeline/Museum Building 1.jpg',
    icon: '🏛️',
    accentColor: '#8B7355',
  },
  {
    ...
    image: '/Timeline/Museum Building 2.jpg',
    icon: '🇮🇳',
    accentColor: '#f37021',
  },
  {
  ...
  },
  {
    ...
    image: '/Timeline/Library Building.jpg',
    icon: '📚',
    accentColor: '#c05621',
  },
  {
