...
const SLIDES = [
  {
    ...
    alt: "Teen Murti Library Panorama",
  },
  {
    src: "/library.jpg",
    alt: "PMML Library Reading Hall",
  },
   {
    src: "/DSC_3203 copy.jpg",
    alt: "PMML Library Building",
  },
];

const INTERVAL_MS = 3000;

export default function LibraryHeroSlider() {
  ...
  return (
    <section
      ...
      aria-label="Library Hero image carousel"
    >
      {/* ── Slide Layers ── */}
      {SLIDES.map((slide, i) => {
